      ...
      <div className="max-w-6xl mx-auto w-full">
        ...
        >
          ...
          <p className="text-xl text-gray-400 max-w-2xl mx-auto">
            Open for freelance opportunities, collaborations, and ambitious projects.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          >
            <div>
              <h2 className="text-3xl font-display font-semibold text-white mb-8">Reach Out directly</h2>
              
              <div className="space-y-6">
                <a href="mailto:abdulwahababdullah3619@gmail.com" className="flex items-center gap-6 p-4 rounded-2xl hover:bg-white/5 transition-colors group interactive">
                  ...
                  <div>
                    ...
                    <p className="text-lg text-white font-medium">abdulwahababdullah3619@gmail.com</p>
                  </div>
                </a>
              </div>
            </div>
            ...
            <div className="mt-12 lg:mt-0">
              <h3 className="text-xl font-display font-semibold text-white mb-6">Connect</h3>
              <div className="flex gap-4">
                <a href="#" className="w-14 h-14 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-gray-300 hover:text-gold hover:border-gold/50 transition-all interactive hover:-translate-y-1">
                  <Github size={24} />
                </a>
                <a href="#" className="w-14 h-14 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-gray-300 hover:text-gold hover:border-gold/50 transition-all interactive hover:-translate-y-1">
                  <Linkedin size={24} />
          ...
          >
            <GlassCard className="p-8 md:p-10">
              <h3 className="text-2xl font-display font-semibold text-white mb-8">Send a Message</h3>
              ...
              {success ? (
                <div className="flex flex-col items-center justify-center py-12 text-center space-y-4">
                  ...
                  <button onClick={() => setSuccess(false)} className="text-gold hover:underline mt-4">Send another message</button>
                </div>
              ) : (
                <form className="space-y-6" onSubmit={handleSubmit}>
                  ...
                  <button disabled={submitContact.isPending} className="w-full py-4 interactive glass-button bg-gold text-black rounded-lg font-bold flex justify-center items-center gap-2 disabled:opacity-50" type="submit">
                    <span>{submitContact.isPending ? 'Sending...' : 'Send Message'}</span>
                    <Send size={18} />
                  </button>
                </form>
              )}
