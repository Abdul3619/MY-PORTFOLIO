...
const services = [
  {
    ...
    description: "Creating tailor-made, exceptionally fast React & Next.js applications featuring immersive UX, fluid micro-interactions, and flawless responsive design.",
    tag: "Premium Code"
  },
  {
    icon: Sun,
    title: "Solar & Smart Energy Systems",
    description: "Designing efficient solar installations, custom off-grid battery grids, hybrid inverter configurations, and smart energy optimization plans.",
    tag: "Sustainable Power"
  },
  {
    icon: Zap,
    title: "Digital Automation & Solving",
    description: "Unraveling complex problems with custom API integrations, speed optimizations, automated workflows, and bulletproof technical solutions.",
    tag: "Complex Fixes"
  }
];
        ...
        <div className="w-full max-w-5xl mx-auto">
          <GlassCard className="p-8 md:p-12 lg:p-16 flex flex-col lg:flex-row items-center gap-12 border-gold/15" glowOnHover>
            ...
            <div className="flex-1 text-center lg:text-left flex flex-col items-center lg:items-start">
              ...
              >
                Bridging premium web software engineering with physical sustainable power grids. Creating responsive luxury interfaces, custom inverter telemetry, and robust systems.
              </motion.p>
      ...
      <section className="relative py-12">
        <div className="w-full max-w-5xl mx-auto px-4">
          <div className="text-center space-y-4 mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-display font-bold text-white">
              Professional <span className="text-gradient font-extrabold">Services</span>
            </h2>
            <p className="text-gray-400 max-w-xl mx-auto text-sm md:text-base">
              Providing top-tier consultation and engineering across digital interfaces and clean energy grids.
            </p>
          </div>
            ...
            {services.map((service, index) => {
              ...
              return (
                <GlassCard key={index} className="p-8 flex flex-col space-y-6 border-white/10" glowOnHover>
                  <span className="text-xs font-bold text-gold/80 tracking-widest uppercase">{service.tag}</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="md:col-span-2 space-y-4">
              ...
              <p className="text-xs text-gray-400 leading-relaxed max-w-sm">
                Self-taught Web Developer & Solar Engineering Technician. Building bespoke digital experiences and cleaner physical grids.
              </p>
            </div>
